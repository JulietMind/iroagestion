...
.article-content { max-width: 800px; margin: 0 auto; padding: 40px; background: var(--bg-card); border-radius: 12px; border: 1px solid rgba(255,255,255,0.05); color: #e2e8f0; line-height: 1.8; font-size: 1.1rem; }
</style>
