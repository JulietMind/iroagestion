const app = {
  ...
  seedDefaults: function() {
    this.data.properties = [
      {
        ...
        progress: 75,
        funded: "75%",
        description: "Torre residencial de lujo situada en el corazón financiero de Madrid. Cuenta con acabados de alta calidad, gimnasio, piscina en azotea y vistas panorámicas de la ciudad. Una inversión segura en una zona de plusvalía garantizada."
      },
      {
        id: 2,
        ...
        progress: 12,
        funded: "12%",
        description: "Nave logística estratégicamente ubicada cerca del puerto de Valencia y principales autopistas. Ideal para empresas de logística y distribución. Certificación energética A."
      },
      {
        id: 3,
        ...
        progress: 0,
        funded: "0%",
        description: "Exclusivo hotel boutique con 25 habitaciones en primera línea de playa en Cala Ratjada. Diseñado por arquitectos de prestigio, ofrece servicios de spa y restauración de alto nivel."
      }
    ];
    ...
    this.data.pages = {
      'sobre-nosotros': { title: 'Sobre Iroa Gestión', body: '<p>Somos líderes...</p>' },
  ...
  loadPropertyDetail: function() {
    ...
    document.getElementById('detail-desc').innerHTML = item.description || "Sin descripción detallada.";
  ...
  handlePropertySubmit: function(e) {
    ...
    const finalImage = imageInput ? imageInput : `https://picsum.photos/seed/${Date.now()}/400/300`;
